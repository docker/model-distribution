...
func TestGARIntegration(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		_ = client.DeleteModel(context.Background(), garTag)
	})
	...
	t.Run("Pull", func(t *testing.T) {
		modelPath, err := client.PullModel(context.Background(), garTag)
		if err != nil {
